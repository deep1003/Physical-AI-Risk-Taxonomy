...
\node[draw=ink, dash pattern=on 2pt off 2pt, rounded corners=5pt, inner sep=6pt,
      ...
      (res) at (-12.0,-8.65)
  {\textbf{결과 · 공개}\ \ L4 \textbf{182}개 = System Safety \textbf{91} · Interaction Safety \textbf{62} · Societal Safety \textbf{29}\ \ \textperiodcentered\ \ 공개: \texttt{pai\_risk\_taxonomy\_bilingual\_v2.0.html} (전체 페이지 · L4 카드 예시 탐색 가능)};
