...
\node[box, minimum width=5.6cm, minimum height=1.5cm] (A) at (-8.2,3.2) {AI 문헌 · 전체 수집\\[2pt]\textbf{\LARGE 3,610,449}};
\node[box, minimum width=5.6cm, minimum height=1.5cm] (B) at (0,3.2)     {Physical AI 문헌\\[2pt]\textbf{\LARGE 416,387}};
\node[box, minimum width=5.6cm, minimum height=1.5cm] (C) at (8.2,3.2)   {Physical AI Risks 문헌\\[2pt]\textbf{\LARGE 84,912}};
\draw[arr] (A) -- (B);
\draw[arr] (B) -- (C);
