...
Worker는 동일한 익명 응답자 ID와 제출 ID를 사용해 접속 telemetry를 비공개 `deep1003/Physical-AI-Risk-Survey-Telemetry` 저장소의 `telemetry/YYYY/MM/` 디렉터리에 별도 저장한다. 공개 응답에는 원본 IP나 정밀 접속정보를 포함하지 않는다.
